...
public class StatsWebSocketHandler extends TextWebSocketHandler {
    ...
    public StatsWebSocketHandler(StatsBridge statsBridge) {
        this.statsBridge = statsBridge;
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        String collectorId = statsBridge.startCollecting(containerId, stats -> {
            try {
                if (session.isOpen()) {
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) {
        ...
        if (collectorId != null) {
            statsBridge.stopCollector(collectorId);
