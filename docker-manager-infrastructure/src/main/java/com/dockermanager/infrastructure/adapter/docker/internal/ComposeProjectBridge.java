 ...
 */
@Component
public class ComposeProjectBridge {

    private static final Logger log = LoggerFactory.getLogger(ComposeProjectBridge.class);
    ...
    public ComposeProjectBridge(DockerClientBridge dockerClient) {
    ...
    public List<ComposeProjectDTO> discoverProjects() {
        List<Container> containers = dockerClient.listAllContainers();
    ...
    public ContainerInfoDTO toContainerInfoDTO(Container container) {
        ...
        try {
            var inspect = dockerClient.inspectContainer(container.getId());
            ...
            try {
                var imageInspect = dockerClient.getDockerClient()
