 ...
 * </pre>
 *
 * @see LogStreamBridge 日志流桥接器（架构类似）
 */
@Component
public class StatsBridge {

    private static final Logger log = LoggerFactory.getLogger(StatsBridge.class);
    ...
    public StatsBridge(DockerClientBridge dockerClient) {
    ...
    public String startCollecting(String containerId, Consumer<ContainerStatsDTO> onStats) {
        ...
        Closeable closeable = dockerClient.statsCmd(containerId).exec(callback);
