...
import com.dockermanager.infrastructure.adapter.docker.internal.DockerClientBridge;
...
public class DockerClientConfig {
    ...
    /**
     * 创建 DockerClientBridge Bean。
     *
     * <p>桥接 DockerClient 到基础设施层的内部适配器，供其他 Bridge 类使用。</p>
     *
     * @param dockerClient 已配置的 DockerClient 实例
     * @return DockerClientBridge 实例
     */
    @Bean
    public DockerClientBridge dockerClientBridge(DockerClient dockerClient) {
        return new DockerClientBridge(dockerClient);
    }
}
