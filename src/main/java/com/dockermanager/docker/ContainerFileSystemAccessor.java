 ...
 * @see DockerClientService#execInContainer(String, String...) 容器内命令执行
 */
@Component
public class ContainerFileSystemAccessor {

    private static final Logger log = LoggerFactory.getLogger(ContainerFileSystemAccessor.class);
    ...
    public ContainerFileSystemAccessor(DockerClientService dockerClientService) {
    ...
    public List<FileEntryDTO> listDirectory(String containerId, String path) {
        ...
        try {
            ...
            String output = dockerClientService.execInContainer(containerId,
    ...
    public String readFile(String containerId, String filePath) {
        try {
            ...
            String output = dockerClientService.execInContainer(containerId, "cat", filePath);
            return output;
        } catch (Exception e) {
    ...
    public InputStream downloadFile(String containerId, String filePath) {
        return dockerClientService.copyArchiveFromContainer(containerId, filePath);
    }
    ...
    private List<FileEntryDTO> listDirectoryViaTar(String containerId, String path) {
        List<FileEntryDTO> entries = new ArrayList<>();
        try (InputStream is = dockerClientService.copyArchiveFromContainer(containerId, path);
    ...
    private String readFileViaTar(String containerId, String filePath) {
        try (InputStream is = dockerClientService.copyArchiveFromContainer(containerId, filePath);
             TarArchiveInputStream tar = new TarArchiveInputStream(is)) {
